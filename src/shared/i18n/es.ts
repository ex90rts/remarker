...
export const es: Messages = {
  ...
  options: {
    ...
    activity: {
      ...
      commonLinks: {
        title: "Enlaces habituales",
        configure: "Configurar enlaces habituales",
        empty: "Añade aquí tus fuentes de lectura frecuentes.",
        ...
        save: "Guardar",
        cancel: "Cancelar",
        maximum: "Hasta {{count}} enlaces. Se intentará obtener el título al salir del campo URL.",
        invalidUrl: "Introduce una URL HTTP(S) completa.",
        fetchingTitle: "Obteniendo el título de la página",
        reorder: "Arrastrar {{label}} para reordenar",
        moveUp: "Subir {{label}}",
        moveDown: "Bajar {{label}}",
        saved: "Enlaces habituales guardados.",
      },
    },
    columns: {
