export const en = {
  ...
  options: {
    ...
    activity: {
      ...
      commonLinks: {
        title: "Common links",
        configure: "Configure common links",
        empty: "Add frequently visited reading sources here.",
        urlLabel: "Link URL",
        textLabel: "Link text",
        add: "Add link",
        delete: "Delete link",
        save: "Save",
        cancel: "Cancel",
        maximum: "Up to {{count}} links. A page title is fetched when the URL field loses focus.",
        invalidUrl: "Enter a complete HTTP(S) URL.",
        fetchingTitle: "Fetching page title",
        reorder: "Drag {{label}} to reorder",
        moveUp: "Move {{label}} up",
        moveDown: "Move {{label}} down",
        saved: "Common links saved.",
      },
    },
    columns: {
